...
public class MyWorld extends World
{
    ...
    {    
        ...
        super(800, 600, 1); 
        weltrettenmensch a = new weltrettenmensch("camel.png","up","down","left","right","enter","heheheha.wav");
        addObject(a, 50, getHeight() - 435);
        weltrettenmensch b = new weltrettenmensch("elephant.png","w","s","a","d","space","grrrrr.wav");
        addObject(b, 50, 430);
    }
    public void act()
    {
